  ...
  return (
    <div className='container'>
      <div className='card'>
        ...
        {data && (
          <div>
            <button align='left' onClick={onClickBack} className='backButton'>
              Back<h3 className='heading2'>Weather App</h3>
            </button>
            <br />
            <br />
            <hr />
            ...
            <h3>
              ...
              <img
                align='middle'
                src='https://cdn4.iconfinder.com/data/icons/ionicons/512/icon-ios7-location-outline-64.png'
                alt=''
                className='location'
              />
              ...
              <div className='col'>
                <div>
                  <p align='left'>
                    ...
                    <img
                      align='left'
                      src='https://cdn0.iconfinder.com/data/icons/autumn-doodles/32/thermometer-autumn-humidity-fall-rain-temperature-measure-64.png'
                      alt=''
                      className='feelslike'
                    />{" "}
                    {state.Feels_like}°C Feels_like{" "}
                  </p>
                </div>
              </div>
              <div className='col'>
                <div>
                  <p align='left'>
                    <img
                      align='left'
                      src='https://cdn4.iconfinder.com/data/icons/weather-717/64/humidity-water-rain-weather-64.png'
                      alt=''
                      className='humidity'
                    />{" "}
